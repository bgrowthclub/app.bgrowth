...
export default function SearchToolbar({ query, onQueryChange, sortValue, onSortChange, sortOptions, children }: Props) {
  return (
    <div className="space-y-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
        <SearchBar value={query} onChange={onQueryChange} className="flex-1" />
